...
/**
 * {@link UncaughtExceptionHandler}  send an e-mail and save log file with
 * some debug information to the developer.
 * 
 *
 */
public class UnCaughtException implements UncaughtExceptionHandler {
  private static final String RECIPIENT = "vishwamk45@gmail.com";
  ...
  public void uncaughtException(Thread t, Throwable e) {
   ...
   // previousHandler.uncaughtException(t, e);
    ...
    private void saveLogFile(StringBuilder report) {
        try {
